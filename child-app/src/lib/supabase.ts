...
const SUPABASE_URL = process.env.SUPABASE_URL ?? 'https://fpgzidwmgkrrubejqkte.supabase.co';
const SUPABASE_ANON_KEY = process.env.SUPABASE_ANON_KEY ?? 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZwZ3ppZHdtZ2tycnViZWpxa3RlIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODg3ODg0MzcsImV4cCI6MjEwNDM2NDQzN30.QqDElodbb-tPWXdmcO72WYo1IQJHKFLEjBB1BuFJLBg';
